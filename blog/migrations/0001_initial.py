    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('today_read_num', models.IntegerField(default=0, verbose_name='今日阅读数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.CharField(max_length=32, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('nid', models.AutoField(primary_key=True, serialize=False)),
                ('read_num', models.IntegerField(default=1, verbose_name='浏览量')),
                ('read_time', models.DateField(auto_now_add=True, verbose_name='阅读量')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='test', to='blog.article')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('nid', models.AutoField(primary_key=True, serialize=False)),
                ('title', models.CharField(max_length=32)),
                ('rate', models.DecimalField(decimal_places=2, max_digits=4, null=True)),
                ('process_color', models.CharField(max_length=32, null=True)),
                ('category_color', models.CharField(default='label-primary', max_length=32, null=True)),
                ('blog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.blog')),
            ],
            options={
                'verbose_name': '日记分类',
